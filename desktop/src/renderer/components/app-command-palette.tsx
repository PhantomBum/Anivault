...
import { Calendar, Compass, Home, Keyboard, List, PictureInPicture2, Search, Settings, Sparkles } from "lucide-react";
  ...
  return (
    <CommandDialog open={open} onOpenChange={onOpenChange}>
      ...
      <CommandList>
        ...
        <CommandSeparator />
        <CommandGroup heading={t("commandPalette.groupComingSoon")}>
          <CommandItem disabled>
            <Compass className="mr-2 h-4 w-4 opacity-50" />
            {t("commandPalette.communityPlaceholder")}
          </CommandItem>
        </CommandGroup>
        <CommandSeparator />
